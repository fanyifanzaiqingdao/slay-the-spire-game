...
export const MASTERY_RULES = {
  ...
  6: { id: 'rest_review_only', description: 'Rest sites no longer offer Heal — only Retro', shortLabel: 'No Healing' },
  ...
  8: { id: 'haunting_forced', description: 'Mistake Graveyard reminders always ON', shortLabel: 'Haunted' },
